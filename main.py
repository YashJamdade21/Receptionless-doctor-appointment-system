...
from turtle import left     # simple graphics
...
class mainwindow:
    def  __init__(self,master):
        ...
        self.submit = Button(root, text="Update", width=20, height=2, bg='red',command=self.update)
        self.submit.place(x=175, y=400)
...
#add appointment- ----------
        ...
        # appointment time
        time = Label(left, text="Appointment Time", font=('arial 18 bold'), fg='black', bg='steelblue')
        time.place(x=0, y=260)
...
root.title("Welcome to ReceptionLess Doctor Appointment System")
